...
public class SqlScript 
{
   ...
   public static boolean registrarColaborador(String nombre,String apellidos,String correo,String funcion,int dni,int telefono)
   {
	   boolean res = false;
   ...
   public static ArrayList<Colaborador> obtenerListaColaboradores()
   {	   	   
	   String sql = "select * from lista_colaboradores() as datos(idc int,nombre character varying(30), apellido character varying(30),correo character varying(30),dni int, telf int,funcion character varying(30));";	
	   ArrayList<Colaborador> respuesta = PostgresConn.funcionDB(sql);
	   return respuesta;	   
   }
}