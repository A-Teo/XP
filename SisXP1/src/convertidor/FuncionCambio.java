    ...
    public double valor(double monto, String monedaInternacional, String monedaLocal) {
        ...
        else 
        {
            if (esDistinto(monedaInternacional, monedaLocal)) {
                ...
                JOptionPane.showMessageDialog(null, "Ingresó el mismo tipo de moneda a convertir");
            } 
            else 
            {
                URL url;
                try {
                    ...
                    res = redondear(Double.parseDouble(extraer(cadena[1], 0))); //redondea a 2 decimales el resultado
                     ...
                     JOptionPane.showMessageDialog(null, "Error de Conexion, revise la conexion a internet");
                    e.printStackTrace();
                } catch (IOException e) {
